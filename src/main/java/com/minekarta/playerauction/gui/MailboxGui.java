...
public class MailboxGui extends PaginatedGui {
    ...
    private void addCustomControls() {
        ...
        if (mailboxItems != null && !mailboxItems.isEmpty()) {
            ...
            claimAllLore.add("");
            claimAllLore.add("&#BDC3C7Claim all items at once");
            claimAllLore.add("");
            claimAllLore.add("&#7F8C8DItems: &#ECF0F1" + mailboxItems.size());
            claimAllLore.add("");
            claimAllLore.add("&#2ECC71Click to claim all");
    ...
    private ItemStack createItemDisplay(MailboxItem mailboxItem) {
        ...
        lore.add("");
        lore.add("&#BDC3C7Reason: &#ECF0F1" + mailboxItem.reason());
        lore.add("&#BDC3C7Quantity: &#ECF0F1" + originalItem.getAmount());
        lore.add("");
        ...
        lore.add("&#BDC3C7Expires in: " + timeColor + timeStr);
        lore.add("");
        lore.add("&#2ECC71▶ ᴄʟɪᴄᴋ ᴛᴏ ᴄʟᴀɪᴍ");
        lore.add("&#7F8C8DItem will be added to inventory");
    ...
    private ItemStack createMoneyDisplay(MailboxItem mailboxItem) {
        ...
        lore.add("");
        lore.add("&#BDC3C7Reason: &#ECF0F1" + mailboxItem.reason());
        lore.add("&#BDC3C7Amount: &#2ECC71" + formattedAmount);
        lore.add("");
        ...
        lore.add("");
        lore.add("&#2ECC71▶ ᴄʟɪᴄᴋ ᴛᴏ ᴄʟᴀɪᴍ");
        lore.add("&#7F8C8DMoney will be deposited to account");
